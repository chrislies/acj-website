...
export async function POST(req) {
  ...
  try {
    ...
    await transporter.sendMail({
      ...mailOptions,
      ...generateEmailContent({ name, email, phone, message }),
      subject: "Inquiry From ACJ Website",
    });
